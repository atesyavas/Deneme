...
int main() {
    ...
    printf("\nSecim yapiniz:\n");
    printf("1. Sezar şifreleme\n");
    printf("2. Atbash şifreleme\n");
    printf("3. Sezar şifre çözme");
    printf("Secim: ");
    scanf("%d", &secim);
    ...
    if (secim == 1) 
    {
        ...
        printf("Cezar Şifreleme ile metin dosyaya yazildi.\n");
    }
    ...
    else if(secim==2)
    {
        ...
        printf("Atbash Şifre Çözme ile metin dosyaya yazildi.\n");
    }   
    ...
    else if(secim==3)
    {
        ...
        printf("Sezar ile şifrelenen metin orijinal haline çevrildi.\n");
    }
